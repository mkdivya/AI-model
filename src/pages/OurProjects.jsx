...
import webDevelopment from '../assets/images/image1.png';
import uiUxDesign from '../assets/images/image1.png';
        ...
        <div className="bg-black min-h-screen text-white py-16 px-8">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-16 items-start">
                    {/* Left Section - Updated to be wider */}
                    <div className="lg:w-2/5">
                        ...
                        <button className="flex items-center gap-2 bg-transparent border border-white px-6 py-3 rounded hover:bg-white hover:text-black transition-all duration-300">
                            LEARN MORE
                            <ArrowRight className="w-4 h-4" />
                        </button>
                    </div>

                    {/* Right Section - Adjusted to complement wider left section */}
